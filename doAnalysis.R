...
currentGraph <- read_csv("summary_csv_day/Malawi/current.csv")
additionalGuidelinesGraph <- read_csv("summary_csv_day/Malawi/additionalGuideline.csv")
enforcedRestrictionsGraph <- read_csv("summary_csv_day/Malawi/enforcedRestrictions.csv")
enforcedLockdownGraph <- read_csv("summary_csv_day/Malawi/enforcedLockdown.csv")
scenario1Graph <- read_csv("summary_csv_day/Malawi/scenario1.csv")
scenario2Graph <-read_csv("summary_csv_day/Malawi/scenario2.csv")
additionalGuidelines21dayGraph <- read_csv("summary_csv_day/Malawi/additionalGuideline21day.csv")
enforcedRestrictions21dayGraph <- read_csv("summary_csv_day/Malawi/enforcedRestrictions21day.csv")
enforcedLockdown21dayGraph <- read_csv("summary_csv_day/Malawi/enforcedLockdown21day.csv")
...
makeComparisonGraph(comparisonDF, "Infected", "Infections", "images/Malawi/infectionScenarios.png")
makeComparisonGraph(comparisonDF, "Hospitalized", "Hospitalizations", "images/Malawi/hospitalizationScenarios.png")
makeComparisonGraph(comparisonDF, "Critical", "Critical Care", "images/Malawi/critcareScenarios.png")
makeComparisonGraph(comparisonDF, "Deaths", "Deaths", "images/Malawi/deathsScenarios.png")
