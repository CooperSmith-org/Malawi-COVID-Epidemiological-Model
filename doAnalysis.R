...
enforcedLockdown <- makeCombinedDF("epi_csvs/Malawi/banded_enforcedLockdown")
...
currentGraphBAND$Reduction <- "2. Current reduction of ~15% continue"
...
enforcedLockdownGraphBAND$Reduction <- "5. Lockdown enforced for 21 day period"
...
comparisonDF <- bind_rows(unmitigatedGraphBAND, currentGraphBAND, enforcedRestrictionsGraphBAND, enforcedLockdownGraphBAND, additionalGuidelinesGraphBAND)
...
makeComparisonGraph(comparisonDF, "Infected", "Infections", "images/Malawi/infectionScenariosAge.png")
makeComparisonGraph(comparisonDF, "Hospitalized", "Hospitalizations", "images/Malawi/hospitalizationScenariosAge.png")
makeComparisonGraph(comparisonDF, "Critical", "Critical Care", "images/Malawi/critcareScenariosAge.png")
makeComparisonGraph(comparisonDF, "Deaths", "Deaths", "images/Malawi/deathsScenariosAge.png")
